...
def create_app(config_name='default'):
    ...
    # Configure dnspython resolver fallback to prevent long timeouts on Windows
    try:
        import dns.resolver
    ...
    if mongo_uri:
        try:
            ...
            print("[TIP] Verify your MONGO_URI in backend/.env or check network/DNS settings.")
            mongo_client = None
            db = None
...
if __name__ == '__main__':
    ...
    print("[INFO] Starting server with WebSocket support...")
